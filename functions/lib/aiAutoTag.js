...
export const checkAiAnalysisStatus = functions
    ...
    try {
        ...
        const db = admin.firestore();
        const doc = await db.collection("marketItems").doc(docId).get();
        if (!doc.exists) {
        ...
        res.json({
            success: true,
            docId,
            aiAnalysisCompleted: (data === null || data === void 0 ? void 0 : data.aiAnalysisCompleted) || false,
            aiAnalyzedAt: (data === null || data === void 0 ? void 0 : data.aiAnalyzedAt) || null,
            aiError: (data === null || data === void 0 ? void 0 : data.aiError) || null
        });
    }
    catch (error) {
...
//# sourceMappingURL=aiAutoTag.js.map