...
exports.approvePendingBlog = exports.aiGenerateClubBlog = void 0;
require("./_admin");
...
function isAdminOfClub(club, uid) {
...
exports.aiGenerateClubBlog = (0, https_1.onCall)({ secrets: [OPENAI_API_KEY] }, async (req) => {
    ...
    if (!data?.title || !data?.content_markdown)
...
// 대기열 승인/거절 (관리자만)
exports.approvePendingBlog = (0, https_1.onCall)({ secrets: [OPENAI_API_KEY] }, async (req) => {
    const uid = req.auth?.uid;
    if (!uid)
        throw new Error("UNAUTHENTICATED");
    ...
    if (!clubSnap.exists)
        throw new Error("CLUB_NOT_FOUND");
    if (!isAdminOfClub(clubSnap.data(), uid))
