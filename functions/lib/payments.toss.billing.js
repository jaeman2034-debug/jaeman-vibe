...
exports.getTossBillingStatus = exports.tossBillingWebhook = exports.chargeTossBilling = exports.issueTossBillingKey = void 0;
require("./_admin");
...
// 빌링키 발급
exports.issueTossBillingKey = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
...
// 정기결제 실행
exports.chargeTossBilling = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', '로그인이 필요합니다.');
    }
...
// Toss 빌링 웹훅
exports.tossBillingWebhook = functions.https.onRequest(async (req, res) => {
    if (req.method !== 'POST') {
...
// 빌링키 상태 조회
exports.getTossBillingStatus = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', '로그인이 필요합니다.');
    }
    try {
