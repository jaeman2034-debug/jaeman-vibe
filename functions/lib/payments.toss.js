...
exports.tossWebhook = exports.confirmTossPayment = exports.createTossCheckout = void 0;
require("./_admin");
...
exports.createTossCheckout = functions.https.onCall(async (data, context) => {
    ...
    const res = await tossFetch('/v1/payments', {
        method: 'POST',
...
exports.confirmTossPayment = functions.https.onCall(async (data, context) => {
    ...
    // Toss 결제 승인
    const res = await tossFetch('/v1/payments/confirm', {
        method: 'POST',
