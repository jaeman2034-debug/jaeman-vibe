...
import { db } from '@/lib/firebase'; // 단일 진입점 사용
    ...
    <main style={{ padding: 24 }}>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <h3 style={{ margin: 0, marginBottom: 8 }}>전체 상품</h3>
          <div style={{ fontSize: 32, fontWeight: 700 }}>{stats.totalProducts}</div>
          <div style={{ fontSize: 14, opacity: 0.8 }}>
            {stats.productsWithoutDong}개 지역정보 없음
          </div>
        </div>
        ...
        <div style={{ 
          ...
          <h3 style={{ margin: 0, marginBottom: 8 }}>전체 모임</h3>
          <div style={{ fontSize: 32, fontWeight: 700 }}>{stats.totalGroups}</div>
          <div style={{ fontSize: 14, opacity: 0.8 }}>
            {stats.groupsWithoutDong}개 지역정보 없음
          </div>
        </div>
        ...
        <div style={{ 
          ...
          <h3 style={{ margin: 0, marginBottom: 8 }}>전체 구직</h3>
          <div style={{ fontSize: 32, fontWeight: 700 }}>{stats.totalJobs}</div>
          <div style={{ fontSize: 14, opacity: 0.8 }}>
            {stats.jobsWithoutDong}개 지역정보 없음
          </div>
        </div>
            ...
            <div style={{ display: 'grid', gap: 8 }}>
              {scheduledBackfills.map(item => (
                <div key={item.id} style={{
                  ...
                  <div>
                    <strong>{item.collection}</strong> 지역정보 백필
