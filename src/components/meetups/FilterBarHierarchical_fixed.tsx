        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-gray-900">계층 필터</span>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              {/* 세부 지점 */}
              <div>
                <label className="text-xs text-zinc-500 ml-2">세부 지점</label>
                <select
                  className="w-full px-3 py-2 rounded-xl bg-white border"
                  value={q.leaf || "all"}
                  onChange={(e) =>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 md:hidden">
          <div className="bg-white h-full overflow-y-auto">
            <div className="sticky top-0 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
              <h3 className="text-lg font-semibold">계층 필터</h3>
              <button
