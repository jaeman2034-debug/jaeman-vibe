...
export default function GroupCreate() {
  ...
  if (!user) return <main style={{ padding: 24 }}>로그인이 필요합니다</main>;
  ...
  return (
    <main style={{ padding: 24, maxWidth: 720, margin: '0 auto' }}>
      ...
      <p style={{ color: '#666' }}>
        {autoMode ? 
          '자동모드 ON: 제목 입력시 AI가 나머지 필드를 자동으로 채워줍니다.' :
          '자동모드 OFF: 수동으로 모든 필드를 입력하세요.'
        }
        위치 설정은 선택사항이며, 설정하면 해당 정보가 자동으로 채워집니다.
      </p>
