...
export default function JobDetail() {
    ...
    return (_jsx("main", { style: { padding: 24, maxWidth: 960, margin: '0 auto' }, children: _jsxs("div", { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }, children: [_jsxs("div", { children: [_jsx("h1", { children: item.title }), item.company && _jsxs("div", { style: { color: '#666', marginTop: 8 }, children: ["\uD68C\uC0AC: ", item.company] }), _jsxs("div", { style: { color: '#444', marginTop: 8 }, children: ["\uC720\uD615: ", getTypeLabel(item.type)] }), (item.salaryMin || item.salaryMax) && (_jsxs("div", { style: { color: '#444', marginTop: 8 }, children: ["\uAE09\uC5EC: ", item.salaryMin ? `${item.salaryMin.toLocaleString()}원` : '', item.salaryMin && item.salaryMax ? ' ~ ' : '', item.salaryMax ? `${item.salaryMax.toLocaleString()}원` : ''] })), item.contact && _jsxs("div", { style: { color: '#666', marginTop: 8 }, children: ["\uC5F0\uB77D\uCC98: ", item.contact] }), item.dong && _jsxs("div", { style: { color: '#777', marginTop: 8 }, children: ["\uD589\uC815\uB3D9: ", item.dong] }), item.loc && (_jsxs("div", { style: { color: '#555', marginTop: 8 }, children: ["\uC704\uCE58: lat ", item.loc.lat.toFixed(5), ", lng ", item.loc.lng.toFixed(5)] })), item.desc && (_jsx("p", { style: { marginTop: 16, whiteSpace: 'pre-wrap', lineHeight: 1.6 }, children: item.desc })), _jsxs("div", { style: { marginTop: 24, display: 'flex', gap: 8 }, children: [_jsx("button", { "data-voice-action": "check-dong", onClick: onCheckDong, disabled: !item.loc, children: "\uD589\uC815\uB3D9 \uD655\uC778" }), isOwner && (_jsxs(_Fragment, { children: [_jsx("button", { disabled: true, children: "\uD3B8\uC9D1" }), _jsx("button", { disabled: true, children: "\uC0AD\uC81C" })] }))] })] }), _jsxs("div", { style: { background: '#f8f8f8', padding: 24, borderRadius: 12 }, children: [_jsx("h3", { children: "\uAD6C\uC778 \uC815\uBCF4" }), _jsxs("div", { style: { marginTop: 16 }, children: [_jsxs("div", { children: [_jsx("strong", { children: "\uC0DD\uC131\uC77C:" }), " ", item.createdAt?.toDate?.()?.toLocaleDateString() || '알 수 없음'] }), _jsxs("div", { children: [_jsx("strong", { children: "\uC18C\uC720\uC790:" }), " ", item.ownerId] }), item.updatedAt && (_jsxs("div", { children: [_jsx("strong", { children: "\uC218\uC815\uC77C:" }), " ", item.updatedAt?.toDate?.()?.toLocaleDateString()] }))] })] })] }) }));
}
